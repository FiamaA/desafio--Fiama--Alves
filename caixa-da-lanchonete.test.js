...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ...
        ['dinheiro', 'R$ 10.90', ['cafe,1', 'sanduiche,1', 'queijo,1']] //acrescentei aqui - pagamento em dinheiro com desconto de 5%
    ...
    test.each([
        ...
        ['com código inexistente', 'credito', 'Item inválido!', ['macarronada, 1']], //acrescentei com codigo inexistente em credito
        ['com código inexistente', 'dinheiro', 'Item inválido!', ['lasanha, 1']],//acrescentei com codigo inexistente em dinheiro
        ['com forma de pagamento inválida', 'especie', 'Forma de pagamento inválida!', ['cafe, 1']],
        ['com forma de pagamento inválida', 'pix', 'Forma de pagamento inválida!', ['cafe, 1']], //acrescentei com forma de pagamento inválida
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
    ...
    test.each([ //aqui estou criando casos de testes para os combos em todas as formas de pagamentos válidas.
        ['dinheiro','R$ 9,50',['suco','sanduiche'],['combo1, 1']],
        ['dinheiro','R$ 7,50',['cafe','sanduiche'],['combo2, 1']],
        ['credito','R$ 9,50',['suco','sanduiche'],['combo1, 1']],
        ['credito','R$ 7,50',['cafe','sanduiche'],['combo2, 1']],
        ['debito','R$ 9,50',['suco','sanduiche'],['combo1, 1']],
        ['debito','R$ 7,50',['cafe','sanduiche'],['combo2, 1']],
    ]) ('compra de combos quantidades em %p deve resultar em %p', validaTeste); 
